...
from aiopnsense import VoucherServerError
...
async def async_setup_services(hass: HomeAssistant) -> None:
    ...
    if SERVICE_CLOSE_NOTICE in enabled_services:
        hass.services.async_register(
            domain=DOMAIN,
            service=SERVICE_CLOSE_NOTICE,
            schema=vol.Schema(
                {
                    vol.Required("id", default="all"): vol.Any(
    ...
    if SERVICE_START_SERVICE in enabled_services:
        hass.services.async_register(
            domain=DOMAIN,
    ...
    if SERVICE_STOP_SERVICE in enabled_services:
        hass.services.async_register(
            domain=DOMAIN,
    ...
    if SERVICE_RESTART_SERVICE in enabled_services:
        hass.services.async_register(
            domain=DOMAIN,
    ...
    if SERVICE_SYSTEM_HALT in enabled_services:
        hass.services.async_register(
            domain=DOMAIN,
    ...
    if SERVICE_SYSTEM_REBOOT in enabled_services:
        hass.services.async_register(
            domain=DOMAIN,
    ...
    if SERVICE_SEND_WOL in enabled_services:
        hass.services.async_register(
            domain=DOMAIN,
    ...
    if SERVICE_RELOAD_INTERFACE in enabled_services:
        hass.services.async_register(
            domain=DOMAIN,
    ...
    if SERVICE_GENERATE_VOUCHERS in enabled_services:
        hass.services.async_register(
            domain=DOMAIN,
    ...
    if SERVICE_KILL_STATES in enabled_services:
        hass.services.async_register(
            domain=DOMAIN,
    ...
    if SERVICE_RUN_SPEEDTEST in enabled_services:
        hass.services.async_register(
            domain=DOMAIN,
    ...
    if SERVICE_GET_VNSTAT_METRICS in enabled_services:
        hass.services.async_register(
            domain=DOMAIN,
    ...
    if SERVICE_TOGGLE_ALIAS in enabled_services:
        hass.services.async_register(
            domain=DOMAIN,
