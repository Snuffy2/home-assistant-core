...
from homeassistant.components.opnsense import services as services_mod
from homeassistant.components.opnsense.const import DOMAIN, SERVICE_GET_VNSTAT_METRICS
